...
/*!**********************!*\
  !*** ./src/front.js ***!
  \**********************/
/*! exports provided: PolcoInstaDoodle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PolcoInstaDoodle", function() { return PolcoInstaDoodle; });
...
var PolcoInstaDoodle = /*#__PURE__*/function (_LitElement) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(PolcoInstaDoodle, _LitElement);

  var _super = _createSuper(PolcoInstaDoodle);

  function PolcoInstaDoodle() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, PolcoInstaDoodle);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(PolcoInstaDoodle, [{
    key: "render",
    value: function render() {
      return Object(lit_element__WEBPACK_IMPORTED_MODULE_6__["html"])(_templateObject || (_templateObject = _babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0___default()(["\n\t\t\t<article class=\"recipe\">\n\t\t\t\t<header class=\"recipe-header\">\n\t\t\t\t\t<slot name=\"header\"></slot>\n\t\t\t\t</header>\n\t\t\t\t<div class=\"recipe-contents ", "\">\n\t\t\t\t\t<slot name=\"contents\"></slot>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"recipe-actions\">\n\t\t\t\t\t<button @click=", ">Read the recipe</button>\n\t\t\t\t</div>\n\t\t\t</article>\n    "])), this.opened ? 'opened' : 'closed', this._onClick);
    }
  }, {
    key: "_onClick",
    ...
    key: "styles",
    get: function get() {
      return Object(lit_element__WEBPACK_IMPORTED_MODULE_6__["css"])(_templateObject2 || (_templateObject2 = _babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0___default()(["\n      :host {\n\t\t\t\t/**\n\t\t\t\t * Styles applied to the host element (i.e. <polcode-recipe>)\n\t\t\t\t */\n      }\n\t\t\t.recipe-contents.closed {\n\t\t\t\tdisplay: none;\n\t\t\t}\n\t\t\t.recipe-contents.opened {\n\t\t\t\tdisplay: block;\n\t\t\t}\n    "])));
    }
  }, {
    key: "properties",
    get: function get() {
